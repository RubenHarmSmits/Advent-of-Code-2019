...
public class IntComputer21 {
    ...
    public IntComputer21(ArrayList<Long> numbers, ArrayList<Long> inputs){
    ...
    private void output(long output){
        if(output>1000) log(output);
        String outputS = Character.toString((char)output);
        introduction.append(outputS);
    }
