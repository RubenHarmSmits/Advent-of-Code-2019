...
public class IntComputer {
    ...
    public IntComputer(ArrayList<Long> numbers, long x, long y){
    ...
    private long output(long output){
        return output;
    }
        ...
        for(int i=0;i<numbers.size();i++){
            ...
            if(opCode<3||opCode==7||opCode==8){
                ...
                if(length>2){
                    ...
                    if(param1==1) return output(numbers.get(i+1));
                    else if(param1==2 ) {
                        return output(numbers.get(toIntExact(numbers.get(i+1)+relativeBase)));
                    }
                    else return output(numbers.get(toIntExact(numbers.get(i+1))));
                } else {
                    return output(numbers.get(toIntExact(numbers.get(i+1))));
                }
