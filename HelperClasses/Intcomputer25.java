...
public class Intcomputer25 {
    ...
    public Intcomputer25(ArrayList<Long> numbers){
    ...
    private void makeAnsi(String input) {
        for (int i = 0; i < input.length(); i++) {
            inputs.add((long)input.charAt(i));
        }
        inputs.add((long)10);
    }

    private void output(long output){
        System.out.print(Character.toString((char)output));
    }
